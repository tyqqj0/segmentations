...
args = {
    ...
    'snapshot': 100,
    'test_step': 1,
    'ckpt_path': 'D:/zhangchaoran/NEW_DATA_TRAIN/public train/xiaorong/no-ream-√rderes/',
    'batch_size': 4,
}
...
opts=dict(title='normal our4 loss', legend=['train loss', 'test loss'], xlabel='epochs', ylabel='loss_value'),env='final_ex')
    value_window = viz.line([[0,0,0,0]], [0],
opts=dict(title='normal our4 value ', legend=['sen', 'spe','dsc','pre'], xlabel='epochs',ylabel='evaluation_value'),env='final_ex')
    #再训练
